...
public class Target extends Rectangle{
	...
	public TargetAnimator animate = new TargetAnimator(0);
	...
	ShapeRenderer shape;
	public Target(int x ,int y,Player player, TiledMapTileLayer level){
		this.player = player;
		this.level = level;
